...
import { NavLink, Button } from '../types'; // Assuming types.ts is in the parent directory
...
const Header: React.FC<HeaderProps> = ({ data }) => {
  return (
    ...
    <div className="flex items-center">
      <div className="mr-3 h-10 w-10 rounded-full bg-yellow-400">
        <img src={data.logo.src} alt={data.logo.alt} className="h-full w-full object-contain" /> 
      </div>
