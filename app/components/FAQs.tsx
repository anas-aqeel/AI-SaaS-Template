            ...
            <div className="mx-auto max-w-7xl px-4 text-center">
                ...
                <ul className="mx-auto max-w-5xl space-y-4">
                    {data.map((faq, index) => (
                        <li
                            key={index}
                            className="overflow-hidden rounded-md border border-[#3C3C77] transition-all"
                        >
                            <button
                            ...
                            >
                                <div className="flex items-center justify-between bg-[#15152c] px-6 py-4 transition duration-300 ease-in-out hover:bg-[#21243e]">
                                    ...
                                    <svg
                                        ...
                                        className={`h-6 w-6 transform text-gray-400 transition duration-300 ease-in-out group-hover:text-[#fedc78] ${expandedIndex === index ? 'rotate-180' : ''}`}
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
